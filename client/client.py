...
def send_request():
    ...
    if choice == 'user':
        ...
        response = requests.post(f'{server_url}/formulario', data=product_data)
        ...
        response = requests.post(f'{server_url}/formulario', data={'usuario_id': user_id, 'producto_id': product_id, 'cantidad': quantity})
